jQuery(function ($) {
    ...
    var qcld_edd_boot_user_init_name = 0;
    var wooChatBotVar = qcld_eddbot_obj;
    console.log(wooChatBotVar);
    var globalwoow={
        initialize:0,
        settings:qcld_eddbot_obj,
        wildCard:0,
        wildcards:'',
    ...
    $(document).ready(function(){
        ...
        $('#woo-chatbot-icon-container').css({
            'right': wooChatBotVar.eddbot_position_x + 'px',
            'bottom': wooChatBotVar.eddbot_position_y + 'px'
        })
        //window resize.
        ...
        $(document).on('click', '#woo-chatbot-ball', function (event) {
            ...
            var qcld_edd_boot_user_init_name = localStorage.getItem("qcld_edd_boot_user_init_name");

           // console.log(qcld_edd_boot_user_init_name);
           ...
           //close button
            ...
            if(chatInitialize==0 && qcld_edd_boot_user_init_name == null){
                ...
                var wooChatBotMsg =wooChatBotVar.i_am +" <strong>"+wooChatBotVar.agent+"</strong>! "+wooChatBotVar.name_greeting+", <strong>"+qcld_edd_boot_user_init_name+"</strong>!";
        ...
        $(document).on('click',"#woo-chatbot-send-message",function(){
            ...
            if( userHitNum == 10 ){
               ...
               // console.log('bargain');
                $("#woo-chatbot-messages-container").append('<li class="woo-chatbot-msg"><img class="woo-chatbot-comment-loader" src="'+wooChatBotVar.image_path+'comment.gif" alt="Typing..." /></li>');
            }else if(qcld_edd_boot_user_init_name != null){
    ...
    function bot_action(userText) {
        ...
        if(userHitNum ==1 && infiniteChat!=1){
            ...
            if(notName.indexOf(userText)>-1 && confirmaNotName==0 ){
               ...
               localStorage.setItem("qcld_edd_boot_user_init_name",  userText);
        ...
        if(userHitNum ==3){
            ...
            var data = {
                'action':'qcld_eddbot_category_products',
                'category':categoryId,
            };
            $.post(wooChatBotVar.ajax_url, data, function (response) {
                if(response.product_num==0){
        ...
        if( userHitNum == 10 ){
            ...
            if( globalwoow.sendusemailstep == 0 ){
                console.log(wooChatBotVar.provide_email_address);
                ...
                var data = {
                    'action':'qcld_eddbot_email',
                    'name': localStorage.getItem("qcld_edd_boot_user_init_name"),
        ...
        if(userHitNum == 9 ){
            ...
            if(globalwoow.wildCard==9 && globalwoow.bargainStep == 'welcome' && globalwoow.bargainId != ''){
                ...
                //alert(userText);
                var data = {
                    'action':'qcld_edd_bargin_product',
                    'qcld_edd_map_product_id':globalwoow.bargainId,
                    'qcld_edd_map_variation_id':globalwoow.bargainVId,
                ...
                $.post(wooChatBotVar.ajax_url, data, function (response) {
                    ...
                    if(spliting===null){
                       // woowMsg.single(globalwoow.your_offer_price_again);
                        ...
                        var data = {
                                'action':'qcld_edd_bargin_product_price',
                                'qcld_edd_map_product_id':globalwoow.bargainId,
                                'qcld_edd_map_variation_id':globalwoow.bargainVId, 
                        ...
                        $.post(wooChatBotVar.ajax_url, data, function (response) {
                            ...
                            if(response.confirm == 'success'){
                                ...
                                setTimeout(function(){
                                    ...
                                    var data = {
                                            'action':'qcld_edd_bargin_product_confirm',
                                            'qcld_edd_map_product_id':globalwoow.bargainId, 
               ...
               // },globalwoow.settings.preLoadingTime);
                ...
                setTimeout(function(){
                    ...
                    var data = {'action':'qcld_edd_bargin_product_confirm',
                            'qcld_edd_map_product_id':globalwoow.bargainId, 
                            'price': globalwoow.bargainPrice,
                            'security': wooChatBotVar.map_free_get_ajax_nonce
                        };
                ...
                setTimeout(function(){
                    ...
                    if(globalwoow.bargainVId != ''){
                        ...
                        var data = {'action':'qcld_edd_bargin_product_variation_add_to_cart',
                       ...
                       var data = {
                        'action':'qcld_edd_bargin_product_add_to_cart',
                        'product_id':globalwoow.bargainId, 
                        'price': globalwoow.bargainPrice,
                        'product_cookie': product_cookie,
                        'security': wooChatBotVar.map_free_get_ajax_nonce
                ...
                setTimeout(function(){
                    ...
                    var data = {'action':'qcld_edd_bargin_send_query',
                                'qcld_edd_map_product_id':globalwoow.bargainId, 
